...
import com.parked.be.beparked.common.transitions.TextResizeTransition;
import com.parked.be.beparked.common.transitions.TransitionBuilder;
...
class ShowDetailsTransitionSet extends TransitionSet {
    ...
    private Transition textResize() {
        return new TransitionBuilder(new TextResizeTransition())
                .link(from.findViewById(R.id.street_name), to.textViewTitle, titleTransitionName())
                .build();
    }
